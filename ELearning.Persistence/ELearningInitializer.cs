    ...
    public class ELearningInitializer
    {
        ...
        private void SeedRole(ELearningDbContext context)
        {
            var roles = new[]
            {
                ...
                new Role { RoleId = 2, Name = "Administrator" }
            };
        ...
        private void SeedEvaluation(ELearningDbContext context)
        {
            var evaluations = new[]
            {
                new Evaluation { EvaluationId = 1, AssignmentId = 1, SectionId = 2, Grade = 5 },
                new Evaluation { EvaluationId = 2, AssignmentId = 1, SectionId = 3, Grade = 8 },
                new Evaluation { EvaluationId = 3, AssignmentId = 1, SectionId = 4, Grade = 5 },
                new Evaluation { EvaluationId = 4, AssignmentId = 1, SectionId = 5, Grade = 1 },
                new Evaluation { EvaluationId = 5, AssignmentId = 1, SectionId = 6, Grade = 9 },
                new Evaluation { EvaluationId = 6, AssignmentId = 1, SectionId = 7, Grade = 2 },
                new Evaluation { EvaluationId = 7, AssignmentId = 1, SectionId = 8, Grade = 4 },
                new Evaluation { EvaluationId = 8, AssignmentId = 1, SectionId = 9, Grade = 8 },
                new Evaluation { EvaluationId = 9, AssignmentId = 1, SectionId = 10, Grade = 7 },
                new Evaluation { EvaluationId = 10, AssignmentId = 1, SectionId = 11, Grade = 5 },
                new Evaluation { EvaluationId = 11, AssignmentId = 1, SectionId = 12, Grade = 6 },
                new Evaluation { EvaluationId = 12, AssignmentId = 2, SectionId = 2, Grade = 4 },
                new Evaluation { EvaluationId = 13, AssignmentId = 2, SectionId = 3, Grade = 7 },
                new Evaluation { EvaluationId = 14, AssignmentId = 2, SectionId = 4, Grade = 4 },
                new Evaluation { EvaluationId = 15, AssignmentId = 2, SectionId = 5, Grade = 5 },
                new Evaluation { EvaluationId = 16, AssignmentId = 2, SectionId = 6, Grade = 6 },
                new Evaluation { EvaluationId = 17, AssignmentId = 2, SectionId = 7, Grade = 4 },
                new Evaluation { EvaluationId = 18, AssignmentId = 2, SectionId = 8, Grade = 2 },
                new Evaluation { EvaluationId = 19, AssignmentId = 2, SectionId = 9, Grade = 6 },
                new Evaluation { EvaluationId = 20, AssignmentId = 2, SectionId = 10, Grade = 9 },
                new Evaluation { EvaluationId = 21, AssignmentId = 2, SectionId = 11, Grade = 2 },
                new Evaluation { EvaluationId = 22, AssignmentId = 2, SectionId = 12, Grade = 5 },
                new Evaluation { EvaluationId = 23, AssignmentId = 3, SectionId = 2, Grade = 6 },
                new Evaluation { EvaluationId = 24, AssignmentId = 3, SectionId = 3, Grade = 3 },
                new Evaluation { EvaluationId = 25, AssignmentId = 3, SectionId = 4, Grade = 5 },
                new Evaluation { EvaluationId = 26, AssignmentId = 3, SectionId = 5, Grade = 2 },
                new Evaluation { EvaluationId = 27, AssignmentId = 3, SectionId = 6, Grade = 6 },
                new Evaluation { EvaluationId = 28, AssignmentId = 3, SectionId = 7, Grade = 8 },
                new Evaluation { EvaluationId = 29, AssignmentId = 3, SectionId = 8, Grade = 4 },
                new Evaluation { EvaluationId = 30, AssignmentId = 3, SectionId = 9, Grade = 5 },
                new Evaluation { EvaluationId = 31, AssignmentId = 3, SectionId = 10, Grade = 10 },
                new Evaluation { EvaluationId = 32, AssignmentId = 3, SectionId = 11, Grade = 1 },
                new Evaluation { EvaluationId = 33, AssignmentId = 3, SectionId = 12, Grade = 3 },
            };
